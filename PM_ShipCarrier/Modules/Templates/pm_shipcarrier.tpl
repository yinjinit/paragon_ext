		...
		<div class="profile-information-col">
			<form class="contact_info">
				<fieldset>
					...
					<small class="profile-information-form-label">{{translate 'Required'}}
						<span class="profile-information-form-group-label-required">*</span></small>

					<div class="profile-information-row" data-input="carrier"
						data-validation="control-group">
						<label class="profile-information-label" for="carrier">{{translate
							'Carrier'}}
							<span class="profile-information-input-required">*</span> </label>
						<div class="profile-information-group-form-controls"
							data-validation="control">
							<select class="global-views-countriesDropdown-select" id="carrier"
								name="carrier" data-action="select-account-type">
								<option value="">
					...
					<div class="profile-information-row" data-input="accountNumber"
						data-validation="control-group">
						<label class="profile-information-label"
							for="accountNumber">{{translate 'Account Number'}}
							<span class="profile-information-input-required">*</span> </label>
						<div class="profile-information-group-form-controls"
							data-validation="control">
							<input type="text" class="profile-information-input-large"
				...
				<div class="profile-information-form-actions">
					<button type="submit"
						class="profile-information-button-update">{{translate
						'Update'}}</button>
				</div>
			</form>
		</div>
...
<form action="#" class="shipcarrier-new">
	...
	<div class="shipcarrier-modal-body">
		...
		<div data-validation="control-group">
			<label for="carrier" class="shipcarrier-form-label">
				{{translate
	'Carrier <small class="shipcarrier-form-required">*</small>'}}
			</label>
		...
		<div data-validation="control-group">
			<label for="accountNumber" class="shipcarrier-form-label">
				{{translate
	'Account Number <small class="shipcarrier-form-required">*</small>'}}
			</label>
			<div class="shipcarrier-form-controls" data-validation="control">
	...
	<div class="{{#if inModal}}shipcarrier-modal-footer{{/if}} shipcarrier-form-controls-group">
		...
		{{#if inModal}}
		<button class="shipcarrier-form-cancel" data-dismiss="modal">{{translate
	'Cancel'}}</button>
		{{/if}}
