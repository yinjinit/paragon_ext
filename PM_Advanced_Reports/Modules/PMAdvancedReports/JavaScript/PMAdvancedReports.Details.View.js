	...
	)
{
	...
	,	page_header: _('Search Results').translate()
		...
		,	initialize: function (options)
		{
			...
			this.model = new PMAdvancedReportsModel({
	...
	, exportCSV: function exportCSV(e){
		...
		var element = document.createElement('a');
				  element.setAttribute('href', 'data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,' + encodeURIComponent(html));
