...
define('PM.Employee.List.View', [
  ...
  return BackboneView.extend({
    ...
    addNewEmployee: function() {
      this.newEmployeeView = new EmployeeCreationView({
    ...
    deleteEmployeeHandler: function(options) {
      ...
      const employee = self.getListFromDom(jQuery(target));
    ...
    editEmployeeHandler: function(e) {
      const employee = this.getListFromDom(jQuery(e.target));
    ...
    childViews: {
      'Employee.ListList': function() {
        return new BackboneCollectionView({
          childView: EmployeeListView,
          viewsPerRow: 1,
