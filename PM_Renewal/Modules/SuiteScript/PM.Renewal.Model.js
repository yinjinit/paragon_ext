    ...
    search: function(list_header_data) {
      ...
      if (list_header_data.from && list_header_data.to) {
        ...
        this.filters.date = new nlobjSearchFilter(
          ...
          new Date(list_header_data.from[0], list_header_data.from[1] - 1,
            list_header_data.from[2]),
          new Date(list_header_data.to[0], list_header_data.to[1] - 1,
            list_header_data.to[2])
        );
...
*/
      ...
      var search = nlapiLoadSearch('customrecord_ng_renewal_tracking',
        'customsearch_ng_account_renewal_tracking')
        , filters = []
      ...
      return this.searchHelper(_.values(this.filters), columns,
        list_header_data.page, selected_filter, selected_companyfilter);
    }
    ...
    getPrimaryContactID: function(email_param, companyid_param) {
      ...
      var searchURL = nlapiResolveURL('SUITELET',
        'customscript_pm_primary_contact_search',
        'customdeploy_pm_primary_contact_search', 'external');

      var primaryContactID = nlapiRequestURL(
        searchURL + '&email_param=' + email_param + '&companyid_param=' +
        companyid_param).getBody();
    ...
    getManufacturer: function() {
      ...
      var searchURL = nlapiResolveURL('SUITELET',
        'customscript_ng_manufacturer_search', 'customdeploy1', true);
    ...
    ,
    searchHelper: function(filters, columns, page, selected_filter,
      selected_companyfilter) {
      'use strict';
      ...
      */
      if (selected_companyfilter) {
        filters.push(
          new nlobjSearchFilter('custrecord_ng_rt_company', null, 'is',
            selected_companyfilter));
      } else {
        filters.push(
          new nlobjSearchFilter('custrecord_ng_rt_company', null, 'is',
      ...
      var self = this
        ,
        result = Application.getAllSearchResults(
          'customrecord_ng_renewal_tracking', filters, columns);
      ...
      renewals.records = _.map(result, function(renewal_record) {
        var current_record_id = renewal_record.getId()
          ,
          created_date = nlapiStringToDate(
            renewal_record.getValue('createddate'))
          ,
          renewal_start_date = nlapiStringToDate(
            renewal_record.getValue('custrecord_ng_rt_start_date'))
          ,
          renewal_date = nlapiStringToDate(
            renewal_record.getValue('custrecord_ng_rt_renewal_date'))
          ,
          renewal_reminder_date = nlapiStringToDate(
            renewal_record.getValue('custrecord_ng_rt_reminder_date'))
          ,
          record = {
            ...
            ,
            custrecord_ng_rt_company_id: renewal_record.getValue(
              'custrecord_ng_rt_company')
            ,
            custrecord_ng_rt_company_name: renewal_record.getText(
              'custrecord_ng_rt_company')
            ...
            ,
            custrecord_ng_rt_primary_contact_id: renewal_record.getValue(
              'custrecord_ng_rt_primary_contact')
            ,
            custrecord_ng_rt_primary_contact_name: renewal_record.getText(
              'custrecord_ng_rt_primary_contact')
            ...
            ,
            custrecord_ng_rt_transaction_id: renewal_record.getValue(
              'custrecord_ng_rt_transaction')
            ,
            custrecord_ng_rt_transaction_name: renewal_record.getText(
              'custrecord_ng_rt_transaction')

            ,
            custrecord_ng_rt_item: renewal_record.getValue(
              'custrecord_ng_rt_item')
            ...
            ,
            custrecord_ng_rt_item_rec_id: renewal_record.getValue(
              'custrecord_ng_rt_item_rec')
            ,
            custrecord_ng_rt_item_rec_name: renewal_record.getText(
              'custrecord_ng_rt_item_rec')
            ...
            ,
            custrecord_ng_rt_renewal_period_id: renewal_record.getValue(
              'custrecord_ng_rt_renewal_period')
            ,
            custrecord_ng_rt_renewal_period_name: renewal_record.getText(
              'custrecord_ng_rt_renewal_period')
            ...
            ,
            custrecord_ng_rt_reminder_period_id: renewal_record.getValue(
              'custrecord_ng_rt_reminder_period')
            ,
            custrecord_ng_rt_reminder_period_name: renewal_record.getText(
              'custrecord_ng_rt_reminder_period')
            ...
            ,
            custrecord_ng_rt_task_id: renewal_record.getValue(
              'custrecord_ng_rt_task')
            ,
            custrecord_ng_rt_task_name: renewal_record.getText(
              'custrecord_ng_rt_task')
            ...
            ,
            custrecord_ng_rt_manufacturer_id: renewal_record.getValue(
              'custrecord_ng_rt_manufacturer')
            ,
            custrecord_ng_rt_manufacturer_name: renewal_record.getText(
              'custrecord_ng_rt_manufacturer')
            ,
            manufacturers: manufacturersSelect
            ,
            createddate: nlapiDateToString(
              created_date ? created_date : self.dummy_date, 'date')
            ,
            custrecord_ng_rt_start_date: nlapiDateToString(
              renewal_start_date ? renewal_start_date : self.dummy_date, 'date')
            ,
            custrecord_ng_rt_renewal_date: nlapiDateToString(
              renewal_date ? renewal_date : self.dummy_date, 'date')
            ,
            custrecord_ng_rt_reminder_date: nlapiDateToString(
              renewal_reminder_date ? renewal_reminder_date : self.dummy_date,
              'date')
            ,
            custrecord_ng_rt_mpn: renewal_record.getValue(
              'custrecord_ng_rt_mpn')
            ,
            custrecord_ng_rt_quantity: renewal_record.getValue(
              'custrecord_ng_rt_quantity')
            ,
            custrecord_ng_rt_renewed: renewal_record.getValue(
              'custrecord_ng_rt_renewed')
            ,
            custrecord_ng_rt_added_by_customer: renewal_record.getValue(
              'custrecord_ng_rt_added_by_customer')
            ,
            custrecord_ng_rt_item_description: renewal_record.getValue(
              'custrecord_ng_rt_item_description')
          };
    ...
    create: function(customerId, data) {
      ...
      var newTrackingRecord = nlapiCreateRecord(
        'customrecord_ng_renewal_tracking');

      data.custrecord_ng_rt_quantity &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_quantity',
        data.custrecord_ng_rt_quantity);
      data.custrecord_ng_rt_mpn &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_mpn',
        data.custrecord_ng_rt_mpn);
      data.custrecord_ng_rt_manufacturer &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_manufacturer',
        data.custrecord_ng_rt_manufacturer);
      data.custrecord_ng_rt_item &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_item',
        data.custrecord_ng_rt_item);
      /*
      ...
      */
      data.custrecord_ng_rt_reminder_date &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_reminder_date',
        nlapiDateToString(
          this.createDate(data.custrecord_ng_rt_reminder_date_hidden)));
      data.custrecord_ng_rt_renewal_date &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_renewal_date',
        nlapiDateToString(
          this.createDate(data.custrecord_ng_rt_renewal_date_hidden)));
      data.custrecord_ng_rt_start_date &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_start_date',
        nlapiDateToString(
          this.createDate(data.custrecord_ng_rt_start_date_hidden)));

      data.custrecord_ng_rt_reminder_period &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_reminder_period',
        data.custrecord_ng_rt_reminder_period);
      data.custrecord_ng_rt_renewal_period &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_renewal_period',
        data.custrecord_ng_rt_renewal_period);

      customerId &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_company', customerId);
      data.custrecord_ng_rt_primary_contact &&
      newTrackingRecord.setFieldValue('custrecord_ng_rt_primary_contact',
        data.custrecord_ng_rt_primary_contact);

      newTrackingRecord.setFieldValue('custrecord_ng_rt_added_by_customer',
        'T');
      newTrackingRecord.setFieldValue('custrecord_ng_rt_show_in_my_account',
        'T');
      newTrackingRecord.setFieldValue('custrecord_ng_rt_renewed',
        data.custrecord_ng_rt_renewed);

      newTrackingRecord.setFieldValue('custrecord_ng_rt_item_description',
        data.custrecord_ng_rt_item_description);
      ...
      if (data && id) {
        nlapiSubmitField('customrecord_ng_renewal_tracking'
          ...
          , [
            ...
            'custrecord_ng_rt_quantity',
            'custrecord_ng_rt_start_date',
            'custrecord_ng_rt_renewal_date',
            'custrecord_ng_rt_reminder_date',
            'custrecord_ng_rt_reminder_period',
            'custrecord_ng_rt_renewal_period'
          ]
          , [
