...
define('PM.Renewal.Details.View', [
  'SC.Configuration',
  ...
  return Backbone.View.extend({
    ...
    , showContent: function() {
      ...
      this.page_header =
        _('Renewal Details RT-$(0)').translate(renewal_number);
    ...
    , showSuccess: function() {
      ...
      this.newRenewalMessage = _.translate('Renewal Deleted');
    ...
    , getContext: function getContext() {
      ...
      //Delete Check
      var addedByCustomerCheck = this.model.get(
      ...
      if (addedByCustomerCheck == 'T') {
        deleteButton =
          '<a class="btn btn-expanded btn-primary case-new-button-submit" data-action="remove-renewal"> DELETE </a>';
      } else {
        deleteButton;
      }
      ...
      var renewal_date_parse = this.model.get(
        'custrecord_ng_rt_renewal_date');
      var reminder_date_parse = this.model.get(
      ...
      var days_to_renewal = this.date_diff_indays(todayParsed,
        renewal_date_parse);
      var days_to_reminder = this.date_diff_indays(todayParsed,
        reminder_date_parse);
      ...
      return {
        ...
        ,
        renewalPeriodName: this.model.get(
          'custrecord_ng_rt_renewal_period_name')

        ,
        reminderPeirodName: this.model.get(
          'custrecord_ng_rt_reminder_period_name')
