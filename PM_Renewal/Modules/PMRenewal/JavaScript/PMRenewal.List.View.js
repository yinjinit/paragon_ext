	...
	,	getContext: function()
		{
			...
			function sortByDate(colnum, direction) {
				...
				if(rows.length > 0){
					...
					rows.sort(function(a,b) {
						//console.log(convertDate(a.cells[colnum].innerHTML) - convertDate(b.cells[colnum].innerHTML));
						//inverse
						if(direction == 'asc'){
							return convertDate(a.cells[colnum].innerHTML) - convertDate(b.cells[colnum].innerHTML);
						}
						if(direction == 'desc'){
							return convertDate(b.cells[colnum].innerHTML) - convertDate(a.cells[colnum].innerHTML);
						}
			  ...
			  if(table.rows.length > 0){
				  ...
				  while (switching) {
				    ...
				    for (i = 1; i < (rows.length - 1); i++) {
				      ...
				      x_text = jQuery(x);
				      y_text = jQuery(y);
				      //console.log(x_text.text().toLowerCase());
				      //console.log(y_text.text().toLowerCase());
				      //check if the two rows should switch place:
				      //if (x.innerHTML.toLowerCase() > y.innerHTML.toLowerCase()) {
				      //if (x_text.text().toLowerCase() > y_text.text().toLowerCase()) {
			...
			jQuery(document).ready(function() {
				...
				jQuery('a.recordviews-title-anchor').each(function( index ) {
				    ...
				    if(title_text){
				       ...
				       var title_text = title_text.replace(/\&amp;/ig,'&');
				       //console.log(title_text);
				...
				var rt_sort_list = jQuery('[name="sort"].list-header-view-accordion-body-select').children("option:selected").val();
				var button_sort_up = jQuery('.list-header-view-accordion-body-button-sort-up').hasClass('listheader-filter-sortorder-arrow-selected');
				var button_sort_down = jQuery('.list-header-view-accordion-body-button-sort-down').hasClass('listheader-filter-sortorder-arrow-selected');
				...
				jQuery('[name="sort"].list-header-view-accordion-body-select').on('change', '[name="sort"].list-header-view-accordion-body-select', function(e){
					//e.preventDefault();
					//e.stopPropagation();
					...
					jQuery('[name="sort"].list-header-view-accordion-body-select').blur();

					return false;
					
				});

				jQuery('[data-action="toggle-sort"].list-header-view-accordion-body-button-sort').on('click tap', '.list-header-view-accordion-body-button-sort', function(e){

					jQuery('[data-action="toggle-sort"].list-header-view-accordion-body-button-sort').focus();
					...
					if(button_sort_up == true){
						...
						jQuery('.list-header-view-accordion-body-button-sort .list-header-view-accordion-body-button-sort-up').removeClass('listheader-filter-sortorder-arrow-selected');
						jQuery('.list-header-view-accordion-body-button-sort .list-header-view-accordion-body-button-sort-down').addClass('listheader-filter-sortorder-arrow-selected');
					}
					...
					if(button_sort_down == true){
						...
						jQuery('.list-header-view-accordion-body-button-sort .list-header-view-accordion-body-button-sort-down').removeClass('listheader-filter-sortorder-arrow-selected');
						jQuery('.list-header-view-accordion-body-button-sort .list-header-view-accordion-body-button-sort-up').addClass('listheader-filter-sortorder-arrow-selected');

					}

					jQuery('[data-action="toggle-sort"].list-header-view-accordion-body-button-sort').blur();
