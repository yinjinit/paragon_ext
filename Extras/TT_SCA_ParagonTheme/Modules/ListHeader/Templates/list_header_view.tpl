		...
		<div class="list-header-view-accordion" data-action="accordion-header">
			...
			<div class="list-header-view-accordion-body {{initiallyCollapsed}}" data-type="accordion-body" {{{accordionStyle}}}>
				<div class="list-header-view-accordion-body-header {{classes}}">
					...
					{{#if keywordFilter}}
						<div class="list-header-view-datepicker-tt">
							<label class="list-header-view-from tt-list-header-view-label" for="keyword">{{translate 'Keyword'}}</label>
							<input type="text" id="keyword" name="keyword" value="{{keyword}}" data-action="keyword-filter" class="list-header-view-tt-body-input">
						</div>
					{{/if}}
					...
					{{#if transactionNameFilter}}
						<div class="list-header-view-datepicker-tt">
							<label class="list-header-view-from" for="transaction-name">{{translate 'Transaction name'}}</label>
							<input type="text" id="transaction-name" name="transaction-name" value="{{transactionName}}" class="list-header-view-tt-body-input" data-action="transaction-name-filter">
						</div>
					{{/if}}					
				</div>
			</div>
