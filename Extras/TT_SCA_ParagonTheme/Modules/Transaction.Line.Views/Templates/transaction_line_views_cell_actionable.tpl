<tr id="{{lineId}}" data-item-id="{{itemId}}" data-type="order-item" {{#if showGeneralClass}} class="{{generalClass}}" {{/if}} >
	<td class="transaction-line-views-cell-actionable-table-middle">
		<div class="transaction-line-views-cell-actionable-name">
			<div class="quick-add-item-thumbnail" name="quick-add-item-thumbnail">
				{{#if isNavigable}}
				<a {{{linkAttributes}}} class="transaction-line-views-cell-actionable-expanded-name-link" target="_blank">
		...
		{{#if isNavigable}}
			<a {{{linkAttributes}}} class="transaction-line-views-cell-actionable-name-link" target="_blank">
				{{item.displayname}}
			</a>
		{{else}}
				<span class="transaction-line-views-cell-actionable-name-viewonly">{{item.displayname}}</span>
		{{/if}}
		</div>
		{{#unless isFreeGift}}
