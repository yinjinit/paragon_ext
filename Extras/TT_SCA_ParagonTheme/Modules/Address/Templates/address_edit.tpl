...
<section class="address-edit">
	...
	<form class="address-edit-form" action="addressbook.ss" method="POST">
		...
		<div class="{{#if isInModal}}address-edit-footer{{else}}form-actions{{/if}}">
			...
			<button class="address-edit-form-button-submit" style="margin-left: 10px;" data-action="update_select">
...
<script>
	...
	function redirect() {
		...
		jQuery('[data-id="8715033"]').find('[data-action="select"]').trigger('click');
	}
