<div class="quote-to-salesorder-wizard-module-confirmation">
	...
	<p class="quote-to-salesorder-wizard-module-confirmation-body">{{translate 'We received  <a href="/purchases/view/salesorder/$(0)">your order ($(1)) </a> and will process it right away.' orderId model.tranid}}</p>
