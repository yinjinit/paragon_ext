...
<ul class="header-menu-myaccount">
	...
	<li class="header-menu-myaccount-overview">
		<a class="header-menu-myaccount-overview-anchor" href="#" data-touchpoint="customercenter" data-hashtag="#overview" name="accountoverview">
			{{translate '<b>Dashboard</b>'}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</a>


{{#if productLists}}
		<a class="header-menu-myaccount-overview-anchor" href="/request-a-quote" data-hashtag="#request-a-quote"
			data-touchpoint="customercenter" title="{{translate 'Edit Quote'}}">{{translate '<b>Edit Quote</b>'}}</a>
{{else}}
		<a class="header-menu-myaccount-overview-anchor" href="/request-a-quote" data-hashtag="#request-a-quote"
			data-touchpoint="customercenter" title="{{translate 'Request A Quote'}}">{{translate '<b>Request A Quote</b>'}}</a>
			{{/if}}
	...
	<li class="header-menu-myaccount-item-level2 header-menu-myaccount-level2-orders" data-permissions="{{purchasesPermissions}}" data-permissions-operator="OR">
		...
		<ul class="header-menu-myaccount-level3 header-menu-myaccount-level3-orders">
			...
			<li data-permissions="{{purchasesPermissions}}">
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#search_transaction" name="search_transaction">
					{{translate 'Search'}}
				</a>
			</li>
			...
			<li data-permissions="{{purchasesPermissions}}">
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#purchases" name="purchases">
					{{translate 'Orders'}}
				</a>
			</li>
			<li data-permissions="{{purchasesPermissions}}">
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#invoices" name="ivnoices">
					{{translate 'Invoices'}}
				</a>
			</li>
			<li data-permissions="{{purchasesPermissions}}">
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#returns" name="returns">
					{{translate 'Return History'}}
				</a>
			</li>
	...
	<!-- <li class="header-menu-myaccount-item-level2">
		<a class="header-menu-myaccount-anchor-level2" href="#" data-action="push-menu" name="purchase_authorization">
			{{translate 'Purchases Authorization'}}
			<i class="header-menu-myaccount-menu-push-icon"></i>
		</a>
		<ul class="header-menu-myaccount-level3">
			<li>
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="purchase_authorization" data-hashtag="#employees">{{translate 'Employees'}}</a>
			</li>
		</ul>
	</li> -->
