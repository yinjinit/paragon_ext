...
<div class="cart-summary">
	...
	{{#if showActions}}
		<div class="cart-summary-button-container">
			{{#if punchoutInformation.isPunchoutSession}}
				<a id="btn-transfer-checkout" data-action="cart-summary-transfer-punchout" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}}" href="{{#if punchoutInformation.allow}} {{punchoutInformation.punchoutURL}}{{/if}}">
					{{translate 'Transfer to Punchout'}}
				</a>
