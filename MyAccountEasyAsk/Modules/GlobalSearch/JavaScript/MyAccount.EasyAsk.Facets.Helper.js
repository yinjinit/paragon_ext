...
define('MyAccount.EasyAsk.Facets.Helper'
, [
   'Facets.Helper'
   , 'Facets.Router'
   , 'SC.Configuration'
...
, function (
   ...
   var MyAccountEasyAskFacetsHelper = _.extend(FacetsHelper, {
         ...
         products = _.map(products, function (product) {
           ...
           //Deon Doughty - 10/28/2020 - new categories
            ...
            return {
               ...
               //Deon Doughty - 11/02/2020 - new categories
                //New cnetCategoryId, nsCategoryId, pricingGroupId
      ...
      getProductsOnNsFormatting: function(easyAskModel) {
         ...
         var products = easyAskModel.getProducts();
         //console.log('My Account Easy Ask getProductsOnNsFormatting easyAskModel');
          //console.log(easyAskModel);

         products = _.map(products, function (product) {

          //console.log('products inside MyAccount.Facets.Helper.js');
   ...
   return MyAccountEasyAskFacetsHelper;
